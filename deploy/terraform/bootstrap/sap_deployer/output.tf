...
output "additional_network_id"                     {
                                                       ...
                                                       value       = length(var.additional_network_id) > 0 ? provider::azurerm::normalise_resource_id(split("/subnets/",lower(var.additional_network_id))[0]) : null
                                                     }
...
output "webapp_url_base"                         {
                                                   ...
                                                   value       = var.application_configuration_deployment ? module.sap_deployer.webapp_url_base : ""
                                                 }

output "webapp_identity"                         {
                                                   description = "The identity of the configuration Web Application"
                                                   value       = var.application_configuration_deployment ? module.sap_deployer.webapp_identity : ""
                                                 }
