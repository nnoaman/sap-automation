...
locals {
  ...
  temp_infrastructure                  = {
                                            ...
                                            application_configuration_id     = try(var.coalesce(var.application_configuration_id, data.landscape_tfstate.outputs.application_configuration_id), "")
                                            control_plane_name               = try(var.coalesce(var.control_plane_name, data.landscape_tfstate.outputs.control_plane_name), "")
