...
function parse_arguments() {
	local input_opts
	input_opts=$(getopt -n installer_v2 -o p:t:o:d:l:s:n:c:w:gahif --longoptions type:,parameter_file:,storage_accountname:,deployer_tfstate_key:,landscape_tfstate_key:,state_subscription:,application_configuration_name:,control_plane_name:,workload_zone_name:,devops,auto-approve,force,github,help -- "$@")
	is_input_opts_valid=$?
