...
#nullable enable
    public class LandscapeModel
    {
        public LandscapeModel()
        {
            ...
            network_logical_name = string.Empty;
            workloadZoneName = string.Empty;
            name_override_file = string.Empty;
        ...
        public string workloadZoneName { get; set; } = string.Empty;
        ...
        public string network_logical_name { get; set; } = string.Empty;
